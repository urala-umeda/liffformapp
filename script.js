    ...
    liff.ready.then(() => {
      ...
      $('.btn-items').append('<li class="inner"><label><div class="flexItem"><img class="flexItem_left btn_animate04" src="https://urala-apps.github.io/liffformapp/sauce.png"></div><button type="submit" id="btn_id_ok" class="btn-left btn_animate04" name="voteLeft" value="">ソースに<br>投票する</button></label></li>');
      $('.btn-items').append('<li class="inner"><label><div class="flexItem"><img class="flexItem_left btn_animate04" src="https://urala-apps.github.io/liffformapp/soy.png"></div><button type="submit" id="btn_id_cancel" class="btn-right btn_animate04" name="voteRight" value="">しょうゆに<br>投票する</button><label></li>');
